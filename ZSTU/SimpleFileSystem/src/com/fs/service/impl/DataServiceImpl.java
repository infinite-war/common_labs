...
public class DataServiceImpl implements DataService {
    ...
    public void init() {
        ...
        FCB rootDir = new FCB("rootDir",Constants.D_FILE,indexNode,null,new LinkedList<>());
        fcbList.add(rootDir);
        ...
        memory.setEmptyBlockNum(Constants.BLOCK_COUNT);
    ...
    public Boolean loadData(String dataPath) {
        ...
        try {
            ...
            memory.setEmptyBlockNum(empty_blockNum);
        } catch (Exception e) {
            e.printStackTrace();
