...
void open_file()
{
	grammar_file.open("F:\\����ԭ���γ���ƴ��\\�﷨����_�ķ�.txt");
    input_file.open("F:\\����ԭ���γ���ƴ��\\output.txt");
    items_file.open("F:\\����ԭ���γ���ƴ��\\��Ŀ��.txt");
    action_file.open("F:\\����ԭ���γ���ƴ��\\������.txt");
    firstset_file.open("F:\\����ԭ���γ���ƴ��\\first��.txt");
    procedure_file.open("F:\\����ԭ���γ���ƴ��\\��������.txt");
}
void LR1()
{
	get_grammar();
